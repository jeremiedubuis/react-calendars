(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactCalendars = {}, global.React));
  ...
  var MonthDay = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(MonthDay, [{
      ...
      value: function render() {
        return /*#__PURE__*/React__default["default"].createElement("button", {
          type: "button",
          disabled: this.props.isDisabledDay(this.props.year, this.props.month + 1, this.props.day),
  ...
  var Month = /*#__PURE__*/function (_React$Component) {
    ...
    function Month(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "isToday", function (day) {
        return _this.isDay(new Date(), day);
      });
    ...
    _createClass(Month, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default["default"].createElement("div", {
        ...
        }, this.props.displayMonthTitle && monthsTitles[this.props.month], this.props.displayDayTitles && /*#__PURE__*/React__default["default"].createElement("ul", {
          ...
          return /*#__PURE__*/React__default["default"].createElement("li", {
            ...
            key: i
          }, i >= _this3.state.offset && /*#__PURE__*/React__default["default"].createElement(MonthDay, {
            isDisabledDay: _this3.props.isDisabledDay,
  ...
  var MonthPicker = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(MonthPicker, [{
      ...
      value: function render() {
        ...
        }, previousButton), this.props.renderMonthTitle ? this.props.renderMonthTitle(monthsTitles[this.props.month], this.props.year) : monthsTitles[this.props.month], /*#__PURE__*/React__default["default"].createElement("button", {
    ...
    _createClass(YearPicker, [{
      ...
      value: function render() {
        return /*#__PURE__*/React__default["default"].createElement("div", {
          ...
          type: "button",
          onClick: this.onClickPrevious
        }, previousButton), this.props.year, /*#__PURE__*/React__default["default"].createElement("button", {
          className: "next-button",
          type: "button",
          onClick: this.onClickNext
        }, nextButton));
  ...
  var Calendar = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(Calendar, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default["default"].createElement("div", {
        ...
        }, this.props.displayYearPicker && /*#__PURE__*/React__default["default"].createElement(YearPicker, {
          setYear: this.setYear,
          year: this.state.year
        }), this.props.displayYearPicker && this.props.afterYearPicker, this.props.displayMonthPicker && /*#__PURE__*/React__default["default"].createElement(MonthPicker, {
          month: this.state.month,
          renderMonthTitle: this.props.renderMonthTitle,
          setMonth: this.setMonth,
          setYear: this.setYear,
          year: this.state.year
        }), this.props.displayMonthPicker && this.props.afterMonthPicker, /*#__PURE__*/React__default["default"].createElement("ul", {
          ...
          return /*#__PURE__*/React__default["default"].createElement("li", {
            ...
            isDisabledDay: _this2.props.isDisabledDay,
  ...
  Calendar.defaultProps = {
    dateClasses: [],
    isDisabledDay: function isDisabledDay() {
      return false;
    },
  ...
  */
  ...
  var reactDom_development=createCommonjsModule(function(module,exports){{(function(){var React=React__default["default"];var _assign=objectAssign;var Scheduler=scheduler;var checkPropTypes=checkPropTypes_1;var tracing$1=tracing;var ReactSharedInternals=React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// Prevent newer renderers from RTE when used with older react package versions.
  ...
  var _parentHasClass = function _parentHasClass(element, classname) {
  ...
  var parentHasClass = function parentHasClass(element) {
    for (var i = 0, iLength = arguments.length <= 1 ? 0 : arguments.length - 1; i < iLength; i++) {
      if (_parentHasClass(element, i + 1 < 1 || arguments.length <= i + 1 ? undefined : arguments[i + 1])) return true;
    }

    return false;
  };

  var _excluded = ["after", "afterMonthPicker", "afterYearPicker", "className", "dataClasses", "dateToValue", "isDisabledDay", "selectedDay", "visibleMonths", "displayDayTitles", "displayMonthPicker", "displayYearPicker", "month", "onSelect", "renderMonthTitle", "valueToDate", "year"];
    ...
    function DatePicker(props) {
      ...
      _defineProperty(_assertThisInitialized(_this), "onFocus", function (e) {
        return _this.setState({
          ...
          if (typeof _this.props.onFocus === 'function') _this.props.onFocus(e);
        });
      });
      ...
      _defineProperty(_assertThisInitialized(_this), "onChange", function (e) {
        ...
        var previousDate = _this.state.selectedDay;
        ...
        _this.setState(state, function () {
          if (typeof _this.props.onChange === 'function') _this.props.onChange(e, state.selectedDay, previousDate);
          if (state.selectedDay && typeof _this.props.onSelect === 'function') _this.props.onSelect(e, state.selectedDay, previousDate);
        });
      });
      ...
      _defineProperty(_assertThisInitialized(_this), "onClickOutside", function (e) {
        if (e.button <= 1) {
          if (_this.inputRef.current.contains(e.target) && !_this.calendarRef || !_this.calendarRef.current || !_this.calendarRef.current.contains(e.target)) {
            if (!_this.targetHasExcludedClass(e.target)) {
              _this.close();
            }
          }
        }
      ...
      _defineProperty(_assertThisInitialized(_this), "onFocusOutside", function (e) {
        if (_this.inputRef.current.contains(e.target) && !_this.calendarRef.current || !_this.calendarRef.current.contains(e.target)) {
          _this.close();
        }
      });
      ...
      _this.calendarRef = /*#__PURE__*/React__default["default"].createRef();
    ...
    _createClass(DatePicker, [{
      ...
      value: function render() {
        var _this$props = this.props;
            _this$props.after;
            _this$props.afterMonthPicker;
            _this$props.afterYearPicker;
            _this$props.className;
            _this$props.dataClasses;
            _this$props.dateToValue;
            _this$props.isDisabledDay;
            _this$props.selectedDay;
            _this$props.visibleMonths;
            _this$props.displayDayTitles;
            _this$props.displayMonthPicker;
            _this$props.displayYearPicker;
            _this$props.month;
            _this$props.onSelect;
            _this$props.renderMonthTitle;
            _this$props.valueToDate;
            _this$props.year;
      ...
      value: function renderCalendar() {
        if (this.state.displayCalendar) return /*#__PURE__*/reactDom.createPortal( /*#__PURE__*/React__default["default"].createElement(Calendar, {
          ...
          after: /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("button", {
            type: "button",
            onClick: this.close,
            className: "close-button"
          }, "Close"), this.props.after),
      ...
      key: "targetHasExcludedClass",
      value: function targetHasExcludedClass(target) {
        var excludedClasses = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
        if (!excludedClasses.length) return false;
        return parentHasClass.apply(void 0, [target].concat(_toConsumableArray(excludedClasses)));
      }
    }]);
