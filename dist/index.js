  ...
  */
  ...
  var DatePicker = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(DatePicker, [{
      ...
      key: "componentDidUpdate",
      value: function componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevProps.selectedDay !== this.props.selectedDay || prevProps.dateToValue !== this.props.dateToValue) this.setState({
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            afterMonthPicker = _this$props.afterMonthPicker,
            afterYearPicker = _this$props.afterYearPicker,
            ...
            displayYearPicker = _this$props.displayYearPicker,
            month = _this$props.month,
            onSelect = _this$props.onSelect,
            renderMonthTitle = _this$props.renderMonthTitle,
            valueToDate = _this$props.valueToDate,
            year = _this$props.year,
            rest = _objectWithoutProperties(_this$props, ["after", "afterMonthPicker", "afterYearPicker", "className", "dataClasses", "dateToValue", "selectedDay", "visibleMonths", "displayDayTitles", "displayMonthPicker", "displayYearPicker", "month", "onSelect", "renderMonthTitle", "valueToDate", "year"]);
      ...
      value: function renderCalendar() {
        if (this.state.displayCalendar) return reactDom.createPortal( /*#__PURE__*/React__default['default'].createElement(Calendar, {
